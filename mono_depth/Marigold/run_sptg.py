...
def depth_predict():
    checkpoint_path = "/calib_data/mono_depth/Marigold/marigold-lcm-v1-0"  # args.checkpoint
    input_rgb_dir = "/calib_data/mono_depth/Marigold/input"  # args.input_rgb_dir
    output_dir = "/calib_data/Marigold/output"  # args.output_dir

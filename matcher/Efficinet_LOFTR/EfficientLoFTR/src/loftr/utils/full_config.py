...
_CN.COARSE.NPE = [1280, 1280, 1280, 1280] # [832, 832, long_side, long_side] Suggest setting based on the long side of the input image, especially when the long_side > 832

# 3. Coarse-Matching config
_CN.MATCH_COARSE = CN()
_CN.MATCH_COARSE.THR = 0.1 # recommend 0.2 for full model and 25 for optimized model
...
_CN.MATCH_FINE = CN()
_CN.MATCH_FINE.LOCAL_REGRESS_TEMPERATURE = 20.0 # use 10.0 as fine local regress temperature, not 1.0

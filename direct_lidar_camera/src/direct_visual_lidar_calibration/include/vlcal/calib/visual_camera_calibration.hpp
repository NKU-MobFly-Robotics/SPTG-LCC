...
public:
  VisualCameraCalibrationParams() {
    ...
    delta_trans_thresh =0.05; //0.1;
    delta_rot_thresh =0.25 * M_PI / 180.0; //0.5 * M_PI / 180.0; //原始
...
Eigen::Isometry3d estimate_pose_SLSQP(const Eigen::Isometry3d& init_T_camera_lidar); 
private:
